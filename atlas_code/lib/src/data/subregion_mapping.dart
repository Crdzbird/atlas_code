/// Maps deprecated or special-use region codes (which some devices still
/// report) to their current ISO 3166-1 alpha-2 equivalent.
const Map<String, String> subregionToAlpha2 = {
